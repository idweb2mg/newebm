...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 23 Mars 2017 à 16:57
...
CREATE TABLE `frrelationclient` (
  ...
  `TYPERELATIONCLIENT` enum('1','2','3','4','5','6') COLLATE utf8_unicode_ci NOT NULL,
...
(1, '1', 'admin', '2017-03-23 03:11:05', '2017-03-23 03:11:05'),
(2, '2', 'moderateur', '2017-03-23 03:12:51', '2017-03-23 03:12:51'),
(3, '3', 'membre', '2017-03-23 03:13:10', '2017-03-23 03:13:10');
...
(1, 'avatar', 'avatar@email.fr', '$2y$10$xsdOWl3LsyM8SEZfZ20AsepWgBeIuY.WL8EwJ/ei5p60/tSt2Oqd2', 2, 0, 0, 0, NULL, '9oMblAjaTOfkQm1VHw66i8D0uGj96Sirbip56aum7CSfdZxc8i1h1pnE6uoS', '2017-03-23 12:53:53', '2017-03-23 12:53:53'),
(2, 'Lara Vel', 'lara@vel.io', '$2y$10$v3DNTqM9BWhMqmWTjVoqxetl4YxY1Ppoc5uP10s9zl/PScwlmPjf2', 2, 0, 0, 0, NULL, 'UpWlIBqXBNDJ13NYkXrJ8ptdxeovc3EmyJB7tjvrb3HOSUY4Df7vUmDT4yNj', '2017-03-23 15:13:08', '2017-03-23 15:13:08');
...
ALTER TABLE `frprojet`
  ...
  ADD KEY `frprojet_id_foreign` (`id`);
...
--
ALTER TABLE `frprojet`
  ADD CONSTRAINT `frprojet_id_foreign` FOREIGN KEY (`id`) REFERENCES `users` (`id`),
